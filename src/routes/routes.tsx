...
const otherRotes: RoutesProps[] = [
  ...
  { path: "/error-notFound", element: <LoadComponent component={lazy(() => import("@src/pages/error/ErrorNotFound"))} /> },
...
const adminRoutes: RoutesProps[] = [
  ...
  { path: "/pages/statistics", element: <LoadComponent component={lazy(() => import("@src/pages/dashboard/Analytics/components/Statistics"))} /> },
  { path: "/pages/personStatistics", element: <LoadComponent component={lazy(() => import("@src/pages/dashboard/Analytics/components/personStatistics"))} /> },
