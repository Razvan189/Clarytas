  ...
  `,
    ...
    return (
        <>
            ...
            {report !== 'person' && <PDFViewer fileName={personData[count].name} style={{justifyContent: "center", display: 'flex', position: 'absolute', height: "100%", left: "20%", zIndex: 30, width: "70%",  display: `${openDocument ? 'block' : 'none'}`}}>
